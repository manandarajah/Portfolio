...
{	
	...
	CSimpleSprite *CreateSprite(const char *fileName, int p_health, int p_enemy_type, float p_offset, int p_bullet_type, int columns, int rows)
	{
		return new CSimpleSprite(fileName, p_health, p_enemy_type, p_offset, p_bullet_type, columns, rows);
	}
