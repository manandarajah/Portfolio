...
#include "PowerUpCharacter.generated.h"

UCLASS(config=Game)
class APowerUpCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	//Accessore function for current power
	UFUNCTION(BlueprintPure, Category = "Power")
	float GetCurrentPower();

	/*Function to update the character's power
		@param PowerChame is the amount to change power by, and it can be positive or negative
	*/
...
protected:
	...
	//The starting power level of a character
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Power", Meta = (BlueprintProtected))
	float InitialPower;

	//SpeedFactor Multiplyer for Character Speed
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Power", Meta = (BlueprintProtected))
	float SpeedFactor;
